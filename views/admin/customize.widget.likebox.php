<?
	$filename = "views/sidebar.like_box.php";
	...
	$string = ''.$content.'';
	$fp = fopen("views/sidebar.like_box.php", "w");
	fwrite($fp, $string);
	fclose($fp);
	redirect('index.php?view=admin&sub_view=customize.widget.likebox');
	
	}
?>
<div class="col-lg-12">
	<div class="well">
	  <form class="bs-example form-horizontal" method="POST" action="index.php?view=admin&sub_view=customize.widget.likebox&token=<?=$_SESSION[token]?>">
		<fieldset>

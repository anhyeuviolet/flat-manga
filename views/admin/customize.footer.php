<?
	...
	$string = ''.$content.'';
	$fp = fopen("views/footer.php", "w");
	fwrite($fp, $string);
	fclose($fp);
	redirect('index.php?view=admin&sub_view=customize.footer');
	
	}
?>
<div class="col-lg-12">
	<div class="well">
	  <form class="bs-example form-horizontal" method="POST" action="index.php?view=admin&sub_view=customize.footer&token=<?=$_SESSION[token]?>">
		<fieldset>
